...
@Component({
  ...
  styleUrls: ['./achievers.component.css']
})
export class AchieversComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.queryReg=this._formBuilder.group(
      {
        id: [this.query.id], 
        fullname: [this.query.fullname,Validators.compose([Validators.required,Validators.minLength(4),Validators.maxLength(10)])],
                 contact : [this.query.contact,Validators.compose([Validators.required,Validators.minLength(10),Validators.maxLength(10)])],
                 subject:['',Validators.compose([Validators.required,Validators.minLength(3),Validators.maxLength(100)])],
                 message:['',Validators.compose([Validators.required,Validators.minLength(3),Validators.maxLength(100)])],
            }
    );
